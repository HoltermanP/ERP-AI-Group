...
export const customers = pgTable("customers", {
  ...
  phone: text("phone"),
  sector: text("sector"),
  aiOpportunity: text("ai_opportunity"),
  leadStatus: text("lead_status").default("prospect"),
  ...
  budgetIndicator: text("budget_indicator"),
  timing: text("timing"),
  competitorCheck: text("competitor_check"),
  kvk: text("kvk"),
  btw: text("btw"),
  notes: text("notes"),
